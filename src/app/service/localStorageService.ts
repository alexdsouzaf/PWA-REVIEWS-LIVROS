...
export class LocalStorageService {
    ...
    listarReviews(pFiltroTexto: string = ""): Array<ReviewsLivrosModel> {
        ...
        if (data){
            const parseConsulta = JSON.parse(data) as Array<ReviewsLivrosModel>
        
            return parseConsulta.filter(item => pFiltroTexto === "" || item.titulo.match(pFiltroTexto))
        }
